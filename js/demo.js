window.bioMp = function(el, options) {
	// Private
	var front = {width: 399, height: 837, ratio: (399 / 838)},
	    side = {width: 302, height: 883, ratio: (302 / 889)};
	...
	function create() {
		...
		if(view == 'front')
			var screenCss = 'position: absolute; top: 72px; left: 13px; width: 375px; height: 669px; border: 0;';
		else if(view == 'left')
